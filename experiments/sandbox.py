...
non_numeric_cols = x_raw.select_dtypes(include=["object"]).columns
print(non_numeric_cols)
for col in non_numeric_cols:
    print(np.unique(x_raw.loc[:,col]))

x = ClasificationTree.prepareX(x_raw)

y_lab, y_cout = np.unique(y, return_counts=True)
print(y_lab, y_cout)
